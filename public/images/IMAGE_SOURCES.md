...
All photos below are from **Pexels** (pexels.com), used under the [Pexels License](https://www.pexels.com/license/) —
free for commercial use, no attribution required. Downloaded at web-optimized widths (1200–1920px, auto-compressed JPEG).
Replace any of these with real company photography whenever it becomes available.
...
| gallery-2-before-kitchen.jpg | https://www.pexels.com/photo/interior-of-a-messy-kitchen-20374786/ | Gallery — Kitchen, before |
| gallery-2-after-kitchen.jpg | https://www.pexels.com/photo/a-clean-kitchen-area-3634739/ | Gallery — Kitchen, after |
| gallery-3-before-carpet.jpg | https://www.pexels.com/photo/5317149/ (worn interior, rug/floor) | Gallery — Carpet, before |
| gallery-3-after-carpet.jpg | https://www.pexels.com/photo/minimal-cozy-living-room-interior-design-12285892/ | Gallery — Carpet, after |
| gallery-4-before-office.jpg | https://www.pexels.com/photo/6539020/ (cluttered office desk) | Gallery — Office, before |
| gallery-4-after-office.jpg | https://www.pexels.com/photo/modern-workspace-interior-with-furniture-under-lamps-in-daytime-7046156/ | Gallery — Office, after |
| logo.png | Provided by client (Nana's Cleaning Service brand assets) | Header / footer logo |

## Testimonial avatars

No stock avatar illustration could be reliably sourced under a confirmed free-commercial license during this pass
(Pixabay blocked automated access). To avoid using real people's photos without consent, testimonial avatars are
rendered as initials badges in the brand palette (see `components/Testimonials.tsx`) instead of image files.

## Gallery before/after treatment

"Before" images are intentionally rendered in grayscale (CSS filter) and "after" images in full color — a deliberate
design choice that also smooths over the fact that these are generic stock placeholders rather than matched
photo pairs of the same room.
